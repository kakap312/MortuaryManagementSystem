...
class SavedBillingInfo{
    ...
    public function __construct($billingId,$createdAt,$corpseId,$billfor,$amount,$extraDays,$dueDays,$serviceFee,$serviceIds){
        $this->billingId = $billingId == ""?uniqid():$billingId;
