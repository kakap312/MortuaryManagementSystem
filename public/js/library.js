...
export function stringValue(name){
      var stringMap = new Map([
        ...
        ["BILL_NOT_FOUND","Sorry No bill was found. Kindly Try again"],
        ["SERVICE_NOT_FOUND","Sorry No service was found. Kindly Try again"],
        ["DELETE_SUCCESS","Congratulation, you have successfully deleted this corpse"],
        ...
        ["ACCOUNT_UPDATE_SUCCESS","Congratulation, you have successfully updated this Account"],
        ...
        ["UPDATE_ACCOUNT_CONFIRMATION","Are you sure you want to update account"],
