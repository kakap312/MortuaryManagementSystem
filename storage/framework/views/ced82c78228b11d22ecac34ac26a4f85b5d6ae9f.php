...
<div class="col-xxl-8 col-md-8 addcorpsection">
    ...
    <div class='forminstructon' data-action= "<?php echo e(route('updatecorp')); ?>" >
    ...
    <select class="fridgename js-example-basic-single form-control" data-action="<?php echo e(route('fetchfridges')); ?>" id='fridgename' name='fridgename'>
