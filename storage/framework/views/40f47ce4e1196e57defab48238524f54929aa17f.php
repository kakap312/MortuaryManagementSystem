<!-- Sales Card -->
<div class="col-xxl-12 col-md-12 viewaccountsection " data-action= "<?php echo e(route('accounts')); ?>">
    <div class="card info-card sales-card viewvillurl" data-action="<?php echo e(route('viewbills')); ?>">
    <div class="card-body ">
    <div id='corpsearchbar'>
        <button type='button' id="searchbtn"  class="ibtn btn-primary searchbtn" data-action="<?php echo e(route('searchclearance')); ?>">Search</button>
