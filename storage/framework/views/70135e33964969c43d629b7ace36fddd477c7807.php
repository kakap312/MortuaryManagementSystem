<!-- Sales Card -->
<div class="col-xxl-12 col-md-12 viewreportsection " data-action= "<?php echo e(route('allclearance')); ?>" >
    ...
    <div id=''>
        ...
        <button type='button' id=""  class="ibtn btn-primary form-control reportbtn" data-action="<?php echo e(route('report')); ?>">Generate</button>
        </div>
        </div>
        </form>
    </div>
    ...
    <div style='display:none;' class='financialreportview reportview'>
        <div class='row financialreportprintarea'>
            ...
            <label for="floatingInput" style='margin-bottom:25px;'></label>
            <button type='button' id="reportprintbtn"  class="ibtn btn-primary form-control financialreportbtn" data-action="<?php echo e(route('searchclearance')); ?>">Print</button>
            </div>
        </div>
    ...
    <div style='display:none;' class='corpsereportview'>
        <div class='row corpsereportarea'>
            ...
            <div class="form-floating mb-3 col reportprint">
            <label for="floatingInput" style='margin-bottom:25px;'></label>
            <button type='button' id="reportprintbtn"  class="ibtn btn-primary form-control reportprintbtn" data-action="<?php echo e(route('searchclearance')); ?>">Print</button>
            </div>
        </div>
